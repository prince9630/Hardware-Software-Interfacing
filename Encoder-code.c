...
{ 
  int32_t posx;
  ParserReturnVal_t retVal = CmdReturnOk;

  if(fetch_int32_arg(&posx)){
    printf("No argument. Please enter (0) for Brake, (1) for Forward, or (2) for reverse.\n");
    retVal = CmdReturnError;
  }
  else{
    switch(posx){
      case 0:
      ...
      case 2:
        ...
        break;
      default:
        printf("Invalid argument. Please enter (0) for Brake, (1) for Forward, or (2) for reverse.\n");
        retVal = CmdReturnError;
        break;
    }
  }
